  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto', color: '#2c3e50' }}>
      <div style={{ textAlign: 'center', marginBottom: '40px', marginTop: '20px' }}>
        <h2 style={{ fontSize: '32px', color: '#1a365d', marginBottom: '10px' }}>Sobre Nosotros</h2>
        <p style={{ color: '#7f8c8d', fontSize: '16px' }}>Conocé la historia detrás de Brillo Total.</p>
      </div>

      <div style={{ backgroundColor: '#ffffff', borderRadius: '12px', padding: '30px', border: '1px solid #e0e0e0', boxShadow: '0 4px 6px rgba(0,0,0,0.02)', lineHeight: '1.8' }}>
        <h3 style={{ color: '#3182ce', marginTop: 0 }}>✨ Nuestra Esencia</h3>
        <p>
        ...
        <h3 style={{ color: '#3182ce', marginTop: '25px' }}>📦 Fraccionamiento Inteligente</h3>
        <p>
        ...
        <h3 style={{ color: '#3182ce', marginTop: '25px' }}>📍 Desde La Rioja para la Región</h3>
        <p>
